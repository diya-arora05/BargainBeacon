document.addEventListener('DOMContentLoaded', () => {
    document.getElementById('productForm').addEventListener('submit', (e) => {
      ...
      const websiteLinks = {
        electronics: [
          `https://example-electronics1.com/product`, // Link to product on website 1
          `https://example-electronics2.com/product`  // Link to product on website 2
        ],
        dailyuse: [
          `https://example-dailyuse1.com/product`,   // Link to product on website 1
          `https://example-dailyuse2.com/product`    // Link to product on website 2
        ]
      };
        ...
        .then(data => {
          ...
          data.forEach((product, index) => {
            ...
            productElement.innerHTML = `
              ...
              <p>Price: $${price}</p>
              <p><a href="${websiteLinks[category][index]}" target="_blank">View on Website ${index + 1}</a></p>
